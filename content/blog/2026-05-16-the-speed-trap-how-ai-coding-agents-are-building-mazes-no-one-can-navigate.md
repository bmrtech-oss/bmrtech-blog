...
To be clear: the productivity gains are real. A 2024 McKinsey study found that 
developers using AI assistants completed well-scoped, clearly defined tasks 35–45% 
faster than those working without them[^6]. GitHub's own Copilot research reported 
that developers finished discrete, bounded tasks up to 55% faster and reported 
higher satisfaction scores[^7]. These are not trivial numbers. The accelerator 
genuinely accelerates.

The problem is the word *scoped*. Every study showing meaningful AI productivity 
gains shares a common condition: the task was well-defined before the agent 
started. When requirements were ambiguous, when the boundaries were unclear, when 
the thinking hadn't happened yet — the gains evaporated. In some studies they 
reversed. The tool works. But it works *on top of* human thinking, not instead of it.
...
[^6]: McKinsey & Company, [*The State of AI in Software Development 2024*](https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/state-of-ai)
[^7]: GitHub, [*Research: Quantifying GitHub Copilot's Impact on Developer Productivity*](https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-on-developer-productivity/)
