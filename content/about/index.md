...
**Pramod M Rathod** 📧 [pramod2rathod@gmail.com](mailto:pramod2rathod@gmail.com) | 🌐 [https://linkedin.com/in/pramodrathod](https://linkedin.com/in/pramodrathod)

**PROFESSIONAL SUMMARY**

Senior Staff Engineer and Solutions Architect with 18+years of experience leading enterprise-scale digital transformation, cloud migration, and AI-driven product innovation. Proven track record of architecting secure, cost-optimized platforms on Azure/AWS that improve scalability and reliability. Strategic leader adept at mentoring high-performing teams, aligning technology with business goals, and delivering complex SaaS products from conception to launch.

**CORE COMPETENCIES**

**Artificial Intelligence & Machine Learning** - End-to-end pipeline expertise: **data engineering, algorithm selection (Naïve Bayes, J48, neural networks), model training & validation (WEKA, scikit-learn, TensorFlow, PyTorch)**, and **API-based deployment** for real-world use cases including **tax code prediction, geocoding, fraud detection, and NLP**. - Successful integration of AI components into web platforms, boosting forecast accuracy and operational efficiency. - Pre-trained Model Deployment, Data Analysis. - Python ML Ecosystem (scikit-learn, TensorFlow, PyTorch, pandas, NumPy, Matplotlib), WEKA, Data Engineering, ETL Pipelines. - Amazon MTurk, Python-based content scraping frameworks, and Hadoop.
...
*   Good knowledge of integrating Authentication and Authorization service providers like Auth0, Okta.
...
*   End-to-End API Development (Node.js, Express, Django, .NET Core, J2EE, RESTful APIs, SOAP).
    

**Project Leadership & Agile Delivery**

*   Accomplished in cross-functional collaboration, technical coaching (teams of 2–10), requirements gathering, documentation, and stakeholder engagement for global product launches and system upgrades.
...
**Frontend Technologies**: React JS, Redux, Material UI, ShadCN UI, Tailwind CSS, Web Components, Micro-Front-End, WebPack Module Federation, HTML, CSS, JS.
...
**Senior Staff Engineer — Atlas Inc** (2022/12 – Present)
...
*   Spearheaded integration of enterprise IAM: deployed **Keycloak for federated authentication**, implemented **SSO** across legacy and modern apps, and improved security posture using **OAuth 2.0 and OpenID Connect**. Implemented 2FA using Email OTP(Sendgrid), SMS Based OTP (Twilio), and application-based login.
    
*   Implemented **design systems using ShadCN UI and Tailwind CSS** to enhance user experience and platform consistency, and migrated legacy systems to a new platform.
...
**Staff Engineer (Software Engineer VI) — Tech9 Inc** (2021/05 – 2022/12)
...
*   Designed, built, and exposed ML algorithms (Naïve Bayes, J48) via scalable APIs, creating reusable pre-trained models for rapid integration across products.
...
**Technical Lead — Symphony Teleca** (2012/05 – 2014/05)
...
**Senior System Engineer — IBM India** (2008/04 – 2012/05)

*   Managed large-scale banking and insurance projects with a focus on security, automated process improvement, and robust system integration.
    
*   Performed the role of technical lead and senior portal developer & and scrum master.
...
**Senior Software Engineer — HSBC Software India** (2006/04 – 2008/04)
...
*   Dr. D. Y. Patil College of Engineering, Savitribai Phule Pune University | 2002/05 – 2006/05
