...
**Artificial Intelligence & Machine Learning**
	- End-to-end pipeline expertise: **data engineering, algorithm selection (Naïve Bayes, J48, neural networks), model training & validation (WEKA, scikit-learn, TensorFlow, PyTorch)**, and **API-based deployment** for real-world use cases including **tax code prediction, geocoding, fraud detection, and NLP**.
